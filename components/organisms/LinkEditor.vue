...
<!--eslint-disable vue/no-mutating-props-->
  <div class="link-editor">
    ...
    <div class="inputs">
      <input  v-model="text" class="input text" name="Texto" type="text" placeholder="Texto"/>
      <input v-model="link" class="input link" name="Link" type="text" placeholder="Link"/>
    </div>
    <div class="actions">
      <Switcher  :state="state" @toggleState="state = !state"/>
